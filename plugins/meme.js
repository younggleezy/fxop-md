...
const memeCommands = [
 { pattern: "trump", image: getAbsolutePath("media/images/trump.png"), x: 70, y: 150, maxWidth: 700, maxLines: 4 },
 { pattern: "elon", image: getAbsolutePath("media/images/elon.jpg"), x: 60, y: 130, maxWidth: 900, maxLines: 5 },
 { pattern: "mark", image: getAbsolutePath("media/images/mark.png"), x: 30, y: 80, maxWidth: 500, maxLines: 3 },
 { pattern: "ronaldo", image: getAbsolutePath("media/images/ronaldo.png"), x: 50, y: 140, maxWidth: 600, maxLines: 4 },
];
 ...
 command(
  ...
  async (message, match) => {
   ...
   try {
    ...
    console.log("Calling buffThumb with:", generatedImage);
    ...
    try {
     await fs.remove(tempImage);
     console.log("Temporary file removed:", tempImage);
    } catch (cleanupError) {
