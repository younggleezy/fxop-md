...
class CommandHandler {
 ...
 async defineCustomCommand(commandDefinition) {
  ...
  const cmdFunction = new Function("axios", "exec", "util", "message", "match", "client", "variableStore", "require", "fs", "path", cmdBody.join(" "));
 ...
 async executeCustomCommand(commandName, message, match, client) {
  ...
  try {
   return await customCommand(axios, exec, util, message, match, client, variableStore, require, fs, path);
  } catch (error) {
