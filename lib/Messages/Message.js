...
const { generateWAMessageFromContent, generateForwardMessageContent, generateWAMessage, proto } = require("baileys");
...
class Message extends Base {
 ...
 async reply(content, options = {}) {
  return this.send(content, { ...options, quoted: this });
 }
 ...
 async edit(content, options = {}) {
  ...
  if (!key) {
   throw new Error("Message key is required for editing");
  }
