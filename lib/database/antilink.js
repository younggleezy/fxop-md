...
exports.setAntiLink = async (chatId, setting) => {
  ...
  const action = /action\/(kick|warn|null)/.test(setting)
    ? setting.replace("action/", "")
    : undefined;
  const allowedUrls =
    action === undefined && isEnabled === undefined ? setting : undefined;
  ...
  Object.assign(context, {
    ...
    allowedUrls: formatAllowedUrls(
      allowedUrls || context.allowedUrls || "null",
    ),
  });
