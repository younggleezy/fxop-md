...
for (const file of files) {
  ...
  if (fileStats.isFile() && path.extname(file) === ".js") {
    ...
    try {
      ...
      // If the module exports an object, merge its properties
      if (typeof moduleExports === "object" && moduleExports !== null) {
        Object.entries(moduleExports).forEach(([key, value]) => {
          exportedModules[key] = value;
        });
      } else {
        // Otherwise, directly assign the module to its name
...
// Make each property of the exported modules object non-enumerable, non-configurable, and non-writable
