...
const play = async inputText => {
   const BaseUrl = "https://api.giftedtechnexus.co.ke";
   const freegiftedapikey = "gifted";
   let videoUrl = inputText;
   ...
   const apiResponse = await fetch(`${BaseUrl}/api/download/ytmp3?url=${encodeURIComponent(videoUrl)}&apikey=${freegiftedapikey}`);
